        ...
        <>
            ...
            <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
                <aside
                    ...
                    id="sidebar"
                >
                    <div className="relative flex-1 flex flex-col min-h-0 borderR border-gray-200 bg-white dark:bg-slate-900 pt-0">
                            ...
                            <div className="flex-1 px-3 bg-white divide-y space-y-1 dark:bg-slate-900">
                                <ul className="space-y-2 pb-2">
                                    {links.map((link) => (
                                        <li key={link.href}>
                                            <Link
                                                className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:hover:bg-slate-800 dark:text-slate-300"
                                                href={link.href}
                                            >
