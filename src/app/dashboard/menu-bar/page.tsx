...
export default function Page() {
    return (
        <div>
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae magni, odit vel dignissimos sed minus molestiae cumque perferendis veniam illo! Laborum amet odio, itaque velit exercitationem iusto debitis voluptas? Incidunt.</p>
        </div>
    );
}
